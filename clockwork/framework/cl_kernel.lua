...
-- Gutting: Removal of hook datastream.
...
function Clockwork:Initialize()
	...
	-- Gutting: Removal of hint convar.
...
function Clockwork:Think()
	...
	-- Gutting: Removal of CalculateHints.
...
function Clockwork:ClockworkSchemaLoaded()
	print(Clockwork.kernel:GetVersion(), "SHIT HTwtggsfdsgfgfdgfasISHTIH")
...
-- Gutting: Removal of hint functions
...
-- Gutting: Removal of HintAdd function
...
function Clockwork:OnClockworkReloaded()
	print("CLIENT UaaCKSaaaaafa")
	//cwTheme:LoadTheme(cwTheme:Get());
	//cwTheme:CreateFonts();
		cwTheme:CopySkin();
	cwTheme:Initialize();

	if (!IsValid(Clockwork.Client) or !IsValid(cwClient)) then
		Clockwork.Client = LocalPlayer();
		cwClient = Clockwork.Client;
	end;
...
function Clockwork:HUDPaint()
	if (!cwKernel:IsChoosingCharacter() and !cwKernel:IsUsingCamera()) then
		...
		-- Gutting: Removal of if tool then hint check. (cringe)
