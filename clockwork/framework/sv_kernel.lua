...
function Clockwork:Tick()
	...
	// Optimization: Gutted hints, will move to optional plugin not installed by default (fuck you hints)

	// Optimization: Gutted wages, will move to optional plugin not installed by default (slightly less fuck you)

	// Optimization: Full gutted, FUCK YOU GENERATORS
